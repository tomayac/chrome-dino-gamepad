...
function Runner(outerContainerId, opt_config) {
  ...
  this.gamepadRestartInterval = null;
  this.gamepadIdleInterval = null;
...
Runner.prototype = {
  ...
  gamepadHandler: function(event, connecting) {
    ...
    if (connecting) {
      ...
      if (!Object.keys(this.gamepads).length) {
        clearInterval(this.gamepadRestartInterval);
        this.gamepadRestartInterval = null;
        clearInterval(this.gamepadIdleInterval);
        this.gamepadIdleInterval = null;
      }
    }
  },

  gamepadRestart: function() {
    if (!this.crashed) {
      return;
    }
  ...
  gameOver: function() {
    ...
    vibrate(200);
    for (let [_, gamepad] of Object.entries(this.gamepads)) {
